...
estado, cep} = dataform;
   ...
   await api.put(`/users/${id}/register`, {nome_cadastro, nome_social_cad, email, num_cartao, data_nasc,  
    raca,naturalidade, endereco, bairro, cidade,
  ...
  return (
    ...
    {formAcept ? (<div><h1>Registrado com Sucesso</h1>
    <button className='btnnewconta'  label='Home' onClick={()=>navigate('/home')} >Voltar ao Home</button>
    </div>):(
